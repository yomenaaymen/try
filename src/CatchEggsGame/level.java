...
//    }
    public level() {
        ...
        AnimListener listener = new LVLGLEventListener();
    ...
    class LVLGLEventListener extends AnimListener {
        ...
        double yegg = 75;
        int xbegg[] = {1, 19, 37, 55, 73, 91};
        int xegg[] = {1, 19, 37, 55, 73, 91};
        int ybegg = 0;
        int score;
        public int lives = 7;
        ...
        public LVLGLEventListener() {
        }

        void levels(GLAutoDrawable gld, int lvl) {

            GL gl = gld.getGL();
            if (lvl == 1) {
                xegg = new int[]{1, 30, 60, 88};

                xbegg = new int[]{1, 30, 60, 88};
                DrawChicken(gl, 1, 85);
...
//            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        void DrawPlayPage(GL gl, GLAutoDrawable gld) {
            ...
            if ((score == Goal || score == Goal + 1) && lives != 0 && timer != 0) {

                renderer1.beginRendering(gld.getWidth(), gld.getHeight());
                renderer1.setColor(Color.WHITE);
                renderer1.draw(Username + " YOU WIN!", gld.getWidth() / 2 - 460, gld.getHeight() / 2);
        ...
        void GameOver(GLAutoDrawable gld) {
            ...
            if (lives <= 0 || timer <= 0) {
                ...
                if (score >= Goal) {
                    renderer1.draw(Username + " YOU WIN!", 250, 480);
                    renderer1.draw("Press B to go to the menu", 250, 200);
